...
brew install anomalyco/tap/ZYRAXON # macOS og Linux (anbefalet, altid up to date)
brew install ZYRAXON              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
ZYRAXON findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/onelpawarai/ZYRAXON-AI/releases) eller [ZYRAXON.ai/download](https://ZYRAXON.ai/download).
...
1. `$ZYRAXON_INSTALL_DIR` - Tilpasset installationsmappe
...
ZYRAXON har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://ZYRAXON.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af ZYRAXON, [**se vores docs**](https://ZYRAXON.ai/docs).

### Bidrag

Hvis du vil bidrage til ZYRAXON, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på ZYRAXON

Hvis du arbejder på et projekt der er relateret til ZYRAXON og bruger "ZYRAXON" som en del af navnet; f.eks. "ZYRAXON-dashboard" eller "ZYRAXON-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af ZYRAXON-teamet og ikke er tilknyttet os på nogen måde.
