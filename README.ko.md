...
mise use -g ZYRAXON               # 어떤 OS든
nix run nixpkgs#ZYRAXON           # 또는 github:onelpawarai/ZYRAXON-AI 로 최신 dev 브랜치
```
...
ZYRAXON 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/onelpawarai/ZYRAXON-AI/releases) 에서 직접 다운로드하거나 [ZYRAXON.ai/download](https://ZYRAXON.ai/download) 를 이용하세요.
...
ZYRAXON 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://ZYRAXON.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

ZYRAXON 설정에 대한 자세한 내용은 [**문서**](https://ZYRAXON.ai/docs) 를 참고하세요.

### 기여하기

ZYRAXON 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### ZYRAXON 기반으로 만들기

ZYRAXON 와 관련된 프로젝트를 진행하면서 이름에 "ZYRAXON"(예: "ZYRAXON-dashboard" 또는 "ZYRAXON-mobile") 를 포함한다면, README 에 해당 프로젝트가 ZYRAXON 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.
