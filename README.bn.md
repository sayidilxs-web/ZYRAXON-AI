...
# Package managers
npm i -g ZYRAXON-ai@latest        # or bun/pnpm/yarn
scoop install ZYRAXON             # Windows
choco install ZYRAXON             # Windows
brew install anomalyco/tap/ZYRAXON # macOS and Linux (recommended, always up to date)
brew install ZYRAXON              # macOS and Linux (official brew formula, updated less)
sudo pacman -S ZYRAXON            # Arch Linux (Stable)
paru -S ZYRAXON-bin               # Arch Linux (Latest from AUR)
mise use -g ZYRAXON               # Any OS
nix run nixpkgs#ZYRAXON           # or github:onelpawarai/ZYRAXON-AI for latest dev branch
```
...
ZYRAXON ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/onelpawarai/ZYRAXON-AI/releases) অথবা [ZYRAXON.ai/download](https://ZYRAXON.ai/download) থেকে ডাউনলোড করুন।
...
1. `$ZYRAXON_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.ZYRAXON/bin` - ডিফল্ট ফলব্যাক
...
ZYRAXON এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://ZYRAXON.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে ZYRAXON কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://ZYRAXON.ai/docs)।

### অবদান (Contributing)

আপনি যদি ZYRAXON এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### ZYRAXON এর উপর বিল্ডিং (Building on ZYRAXON)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা ZYRAXON এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "ZYRAXON" ব্যবহার করেন, উদাহরণস্বরূপ "ZYRAXON-dashboard" বা "ZYRAXON-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি ZYRAXON দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।
