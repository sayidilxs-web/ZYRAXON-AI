...
- `ZYRAXON` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `ZYRAXON` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `ZYRAXON` in prose, `ZYRAXON` only for exact technical identifiers
