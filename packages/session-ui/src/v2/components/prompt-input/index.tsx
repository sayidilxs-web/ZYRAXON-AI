  ...
  return (
    <div class={`relative size-full flex flex-col gap-0 ${props.class ?? ""}`}>
      ...
      <form
        ...
        class="group/prompt-input relative min-h-[96px] w-full rounded-xl bg-v2-background-bg-base shadow-[var(--v2-elevation-raised)] zyraxon-chat-border"
...
function PromptInputV2MicButton(props: {
  ...
  return (
    <TooltipV2 placement="top" value={tooltipText()}>
      <button
        type="button"
