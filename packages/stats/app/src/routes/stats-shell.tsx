...
export const githubLink = {
  href: "https://github.com/onelpawarai/ZYRAXON-AI",
  apiHref: "https://api.github.com/repos/onelpawarai/ZYRAXON-AI",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "zyraxon:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://zyraxon.ai/">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://zyraxon.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://zyraxon.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@zyraxon.ai", label: i18n.t("footer.contact") },
    { href: "https://zyraxon.ai/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://zyraxon.ai" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={opencodeWordmarkDark} alt="ZYRAXON" />
          <button
