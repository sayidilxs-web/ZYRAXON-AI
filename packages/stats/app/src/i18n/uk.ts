export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | ZYRAXON Data",
  "app.description":
    "Досліджуйте використання ZYRAXON Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак ZYRAXON Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку ZYRAXON на GitHub",
  "header.github": "GitHub",
  "header.tryZYRAXON": "Спробувати ZYRAXON",
  ...
  "footer.homeAria": "Головна ZYRAXON",
  ...
  "home.topModelsDescription": "Використання моделей в ZYRAXON Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі ZYRAXON Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | ZYRAXON Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в ZYRAXON Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання ZYRAXON.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в ZYRAXON",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання ZYRAXON",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів ZYRAXON за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | ZYRAXON Data",
  "model.description":
    "Перегляньте дані використання {{model}} в ZYRAXON Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання ZYRAXON Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні ZYRAXON Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні ZYRAXON Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання ZYRAXON Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени ZYRAXON Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання ZYRAXON Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів ZYRAXON Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі ZYRAXON Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу ZYRAXON Go.",
  ...
  "model.geoDescription": "Токени моделі ZYRAXON Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки ZYRAXON Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів ZYRAXON Go.",
