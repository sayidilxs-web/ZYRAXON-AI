export const dict = {
  "app.title": "Ranking de uso de modelos de IA | ZYRAXON Data",
  "app.description":
    "Explore o uso do ZYRAXON Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do ZYRAXON Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao ZYRAXON no GitHub",
  "header.github": "GitHub",
  "header.tryZYRAXON": "Experimente o ZYRAXON",
  ...
  "footer.homeAria": "Início do ZYRAXON",
  ...
  "modal.title": "Newsletter do ZYRAXON",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no ZYRAXON Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do ZYRAXON Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | ZYRAXON Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no ZYRAXON Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do ZYRAXON.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no ZYRAXON",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do ZYRAXON",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do ZYRAXON nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | ZYRAXON Data",
  "model.description":
    "Veja dados de uso de {{model}} no ZYRAXON Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no ZYRAXON Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do ZYRAXON Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do ZYRAXON Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do ZYRAXON Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do ZYRAXON Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do ZYRAXON Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do ZYRAXON Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do ZYRAXON Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do ZYRAXON Go.",
  ...
  "model.geoDescription": "Tokens do modelo ZYRAXON Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do ZYRAXON Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do ZYRAXON Go.",
