export const dict = {
  "app.title": "Rankingi użycia modeli AI | ZYRAXON Data",
  "app.description":
    "Przeglądaj użycie ZYRAXON Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny ZYRAXON Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę ZYRAXON na GitHub",
  "header.github": "GitHub",
  "header.tryZYRAXON": "Wypróbuj ZYRAXON",
  ...
  "footer.homeAria": "Strona główna ZYRAXON",
  ...
  "home.topModelsDescription": "Użycie modeli w ZYRAXON Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy ZYRAXON Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | ZYRAXON Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w ZYRAXON Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia ZYRAXON.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w ZYRAXON",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia ZYRAXON",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów ZYRAXON z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | ZYRAXON Data",
  "model.description":
    "Zobacz dane użycia {{model}} w ZYRAXON Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie ZYRAXON Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu ZYRAXON Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu ZYRAXON Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia ZYRAXON Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny ZYRAXON Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia ZYRAXON Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów ZYRAXON Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy ZYRAXON Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji ZYRAXON Go.",
  ...
  "model.geoDescription": "Tokeny modelu ZYRAXON Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne ZYRAXON Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów ZYRAXON Go.",
