export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | ZYRAXON Data",
  "app.description":
    "ZYRAXON Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde ZYRAXON Data logosu",
  ...
  "header.githubAria": "GitHub'da ZYRAXON'a yıldız ver",
  "header.github": "GitHub",
  "header.tryZYRAXON": "ZYRAXON'u dene",
  ...
  "footer.homeAria": "ZYRAXON ana sayfası",
  ...
  "home.topModelsDescription": "ZYRAXON Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz ZYRAXON Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | ZYRAXON Data",
  "lab.description":
    "ZYRAXON Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son ZYRAXON kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "ZYRAXON'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son ZYRAXON kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük ZYRAXON token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | ZYRAXON Data",
  "model.description":
    "{{model}} için ZYRAXON Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda ZYRAXON Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki ZYRAXON Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki ZYRAXON Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde ZYRAXON Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son ZYRAXON Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz ZYRAXON Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük ZYRAXON Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz ZYRAXON Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama ZYRAXON Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan ZYRAXON Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen ZYRAXON Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son ZYRAXON Go token hacmine göre yakındaki modeller.",
