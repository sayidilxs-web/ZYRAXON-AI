...
const en = {
  "app.title": "AI Model Usage Rankings | ZYRAXON Data",
  "app.description":
    "Explore ZYRAXON Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "ZYRAXON Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star ZYRAXON on GitHub",
  "header.github": "GitHub",
  "header.tryZYRAXON": "Try ZYRAXON",
  ...
  "home.topModelsDescription": "Usage of models across ZYRAXON Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique ZYRAXON Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | ZYRAXON Data",
  "lab.description":
    "Compare {{lab}} models used in ZYRAXON Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent ZYRAXON usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in ZYRAXON",
  ...
  "lab.shareOfUsage": "{{share}} of recent ZYRAXON usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | ZYRAXON Data",
  "model.description":
    "View {{model}} ZYRAXON Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. ZYRAXON Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's ZYRAXON Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's ZYRAXON Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No ZYRAXON Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no ZYRAXON Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "ZYRAXON Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No ZYRAXON Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent ZYRAXON Go token volume.",
