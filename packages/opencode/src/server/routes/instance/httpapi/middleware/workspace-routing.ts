...
>()("@zyraxon/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@zyraxon/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ZYRAXON_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ZYRAXON_WORKSPACE_ID) : undefined
}
