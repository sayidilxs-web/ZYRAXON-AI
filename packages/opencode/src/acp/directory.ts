...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@zyraxon/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@zyraxon/ACPDirectory") {}
