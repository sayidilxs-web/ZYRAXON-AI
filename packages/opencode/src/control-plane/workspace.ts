...
export class Service extends Context.Service<Service, Interface>()("@zyraxon/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ZYRAXON_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ZYRAXON_WORKSPACE_ID: config.id,
        ZYRAXON_EXPERIMENTAL_WORKSPACES: "true",
