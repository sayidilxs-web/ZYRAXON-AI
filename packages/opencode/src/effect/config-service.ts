 ...
 *   "@zyraxon/ServerAuthConfig",
 *   {
 *     password: Config.string("ZYRAXON_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ZYRAXON_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
