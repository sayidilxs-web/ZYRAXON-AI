...
export class Service extends Context.Service<Service, Interface>()("@zyraxon/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ZYRAXON_FAKE_VCS)
