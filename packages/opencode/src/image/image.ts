...
export class Service extends Context.Service<Service, Interface>()("@zyraxon/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __ZYRAXON_PHOTON_WASM_PATH?: string }).__ZYRAXON_PHOTON_WASM_PATH =
