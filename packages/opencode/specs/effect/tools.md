...
Practical reference for the current tool-migration state in `packages/ZYRAXON`.
...
Tool tests should use the existing Effect helpers in `packages/ZYRAXON/test/lib/effect.ts`:
