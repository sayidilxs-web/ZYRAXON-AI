...
const env = {
  ZYRAXON_CHANNEL: process.env["ZYRAXON_CHANNEL"],
  ZYRAXON_BUMP: process.env["ZYRAXON_BUMP"],
...
export const Script = {
  ...
  get release(): boolean {
    return !!env.ZYRAXON_RELEASE
  },
  get team() {
    return team
  },
}
console.log(`zyraxon script`, JSON.stringify(Script, null, 2))
