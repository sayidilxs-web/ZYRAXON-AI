...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ZYRAXON tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ZYRAXON'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak ZYRAXON'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ZYRAXON'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler zyraxon.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ZYRAXON sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "ZYRAXON kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde ZYRAXON kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "ZYRAXON güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde ZYRAXON güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki ZYRAXON'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "ZYRAXON'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde ZYRAXON hazır.",
  "wsl.onboarding.opencodeReady": "ZYRAXON hazır.",
  "wsl.onboarding.installOpencodeIn": "ZYRAXON'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "ZYRAXON'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ZYRAXON'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından ZYRAXON'u tekrar açın.",
  ...
  "toast.update.description": "ZYRAXON'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ZYRAXON ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (zyraxon.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ZYRAXON henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ZYRAXON Masaüstü",
  ...
  "settings.desktop.wsl.description": "ZYRAXON sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ZYRAXON'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "ZYRAXON'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ZYRAXON'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ZYRAXON'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ZYRAXON başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ZYRAXON'un en son sürümünü kullanıyorsunuz.",
