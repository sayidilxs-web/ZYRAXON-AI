...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ZYRAXON.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i zyraxon.json",
  ...
  "dialog.server.description": "Bytt hvilken ZYRAXON-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ZYRAXON ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ZYRAXON-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (zyraxon.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ZYRAXON ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ZYRAXON-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ZYRAXON",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ZYRAXON ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ZYRAXON skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ZYRAXON er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ZYRAXON starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ZYRAXON.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker ZYRAXON i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer ZYRAXON i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater ZYRAXON i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer ZYRAXON i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før ZYRAXON kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter ZYRAXON på nytt.",
