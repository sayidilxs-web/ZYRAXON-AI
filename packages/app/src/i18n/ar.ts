export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك ZYRAXON Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في ZYRAXON.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في zyraxon.json",
  ...
  "dialog.server.description": "تبديل خادم ZYRAXON الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من ZYRAXON في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث ZYRAXON في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث ZYRAXON في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت ZYRAXON في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن ZYRAXON من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على ZYRAXON التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح ZYRAXON.",
  ...
  "toast.update.description": "نسخة جديدة من ZYRAXON ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق ZYRAXON",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (zyraxon.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن ZYRAXON لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن ZYRAXON نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم ZYRAXON داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ ZYRAXON",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور ZYRAXON على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان ZYRAXON يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة ZYRAXON.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل ZYRAXON",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من ZYRAXON.",
