export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ZYRAXON.",
  ...
  "dialog.plugins.empty": "Plugins configurados em zyraxon.json",
  ...
  "dialog.server.description": "Trocar para qual servidor ZYRAXON este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o ZYRAXON em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o ZYRAXON em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o ZYRAXON em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "O ZYRAXON está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O ZYRAXON está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o ZYRAXON em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o ZYRAXON possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O ZYRAXON não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o ZYRAXON novamente.",
  ...
  "toast.update.description": "Uma nova versão do ZYRAXON ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ZYRAXON",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (zyraxon.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ZYRAXON ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ZYRAXON dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ZYRAXON",
  ...
  "settings.general.row.appearance.description": "Personalize como o ZYRAXON aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ZYRAXON segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ZYRAXON é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ZYRAXON iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ZYRAXON.",
