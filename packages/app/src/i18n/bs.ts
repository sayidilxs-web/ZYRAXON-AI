export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ZYRAXON-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ZYRAXON-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ZYRAXON-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u zyraxon.json",
  ...
  "dialog.server.description": "Promijeni na koji se ZYRAXON server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera ZYRAXON u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje ZYRAXON u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj ZYRAXON u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj ZYRAXON u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi ZYRAXON mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori ZYRAXON.",
  ...
  "toast.update.description": "Nova verzija ZYRAXON-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ZYRAXON timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (zyraxon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ZYRAXON još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ZYRAXON server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ZYRAXON-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako ZYRAXON izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ZYRAXON prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ZYRAXON-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ZYRAXON pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ZYRAXON-a.",
