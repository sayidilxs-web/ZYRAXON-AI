...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ZYRAXON zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "zyraxon.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ZYRAXON zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ZYRAXON zu nutzen.",
  ...
  "dialog.plugins.empty": "In zyraxon.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den ZYRAXON-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.zyraxon": "ZYRAXON",
  ...
  "wsl.onboarding.checkingOpencode": "ZYRAXON wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "ZYRAXON in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "ZYRAXON wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "ZYRAXON in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie ZYRAXON in {{distro}}.",
  "wsl.onboarding.updateOpencode": "ZYRAXON aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "ZYRAXON ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie ZYRAXON in {{distro}}.",
  "wsl.onboarding.installOpencode": "ZYRAXON installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor ZYRAXON einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann ZYRAXON erneut.",
  ...
  "toast.update.description": "Eine neue Version von ZYRAXON ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ZYRAXON-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (zyraxon.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ZYRAXON unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "ZYRAXON Desktop",
  ...
  "settings.desktop.wsl.description": "ZYRAXON-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ZYRAXON ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie ZYRAXON auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob ZYRAXON dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ZYRAXON anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ZYRAXON automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ZYRAXON.",
