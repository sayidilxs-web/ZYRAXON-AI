export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ZYRAXON.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w zyraxon.json",
  ...
  "dialog.server.description": "Przełącz serwer ZYRAXON, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie ZYRAXON w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie ZYRAXON w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj ZYRAXON w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj ZYRAXON w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim ZYRAXON będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz ZYRAXON.",
  ...
  "toast.update.description": "Nowa wersja ZYRAXON ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ZYRAXON",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (zyraxon.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: ZYRAXON nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer ZYRAXON wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ZYRAXON",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd ZYRAXON na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ZYRAXON ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ZYRAXON.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ZYRAXON",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ZYRAXON.",
