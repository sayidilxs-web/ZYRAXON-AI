export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ZYRAXON.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i zyraxon.json",
  ...
  "dialog.server.description": "Skift hvilken ZYRAXON-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker ZYRAXON i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer ZYRAXON i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater ZYRAXON i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før ZYRAXON kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter ZYRAXON igen.",
  ...
  "toast.update.description": "En ny version af ZYRAXON ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ZYRAXON-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (zyraxon.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ZYRAXON understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ZYRAXON-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ZYRAXON",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan ZYRAXON ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om ZYRAXON følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ZYRAXON er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ZYRAXON starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ZYRAXON.",
