export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ZYRAXONが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、ZYRAXONで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してZYRAXONで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、ZYRAXONで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "zyraxon.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するZYRAXONサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "ZYRAXONを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のZYRAXONを確認中...",
  "wsl.onboarding.updatingOpencode": "ZYRAXONを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のZYRAXONを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のZYRAXONを更新してください。",
  "wsl.onboarding.updateOpencode": "ZYRAXONを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のZYRAXONの準備ができました。",
  "wsl.onboarding.opencodeReady": "ZYRAXONの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にZYRAXONをインストールしてください。",
  "wsl.onboarding.installOpencode": "ZYRAXONをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXONがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ZYRAXONでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、ZYRAXONをもう一度開いてください。",
  ...
  "toast.update.description": "ZYRAXONの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをZYRAXONチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (zyraxon.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ZYRAXONはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXONには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でZYRAXONサーバーを実行します。",
  ...
  "settings.general.row.language.description": "ZYRAXONの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのZYRAXONの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "ZYRAXONがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "ZYRAXONのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "ZYRAXON の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "ZYRAXON は最新バージョンです。",
