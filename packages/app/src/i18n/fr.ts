export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ZYRAXON.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans zyraxon.json",
  ...
  "dialog.server.description": "Changez le serveur ZYRAXON auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'ZYRAXON dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'ZYRAXON dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour ZYRAXON dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez ZYRAXON dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'ZYRAXON puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez ZYRAXON.",
  ...
  "toast.update.description":
    "Une nouvelle version d'ZYRAXON ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ZYRAXON",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zyraxon.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ZYRAXON ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "ZYRAXON inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur ZYRAXON dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ZYRAXON",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'ZYRAXON sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si ZYRAXON suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ZYRAXON.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ZYRAXON",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ZYRAXON.",
