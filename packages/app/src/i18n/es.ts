export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ZYRAXON",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ZYRAXON.",
  ...
  "provider.connect.opencodeZen.line1":
    "ZYRAXON Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ZYRAXON.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ZYRAXON.",
  ...
  "dialog.plugins.empty": "Plugins configurados en zyraxon.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ZYRAXON se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando ZYRAXON...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando ZYRAXON en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando ZYRAXON...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando ZYRAXON en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza ZYRAXON en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar ZYRAXON",
  "wsl.onboarding.opencodeReadyIn": "ZYRAXON está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "ZYRAXON está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala ZYRAXON en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ZYRAXON no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que ZYRAXON pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "ZYRAXON no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir ZYRAXON.",
  ...
  "toast.update.description": "Una nueva versión de ZYRAXON ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ZYRAXON",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (zyraxon.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ZYRAXON no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "ZYRAXON incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ZYRAXON dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ZYRAXON",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve ZYRAXON en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ZYRAXON sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ZYRAXON.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ZYRAXON",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ZYRAXON.",
