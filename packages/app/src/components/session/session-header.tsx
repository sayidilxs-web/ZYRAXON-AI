...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("zyraxon-titlebar-center"))
  })
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    <div class="hidden md:flex items-center gap-1 shrink-0">
                      ...
                      >
                        <Button
                          variant="ghost"
                          class="titlebar-icon w-8 h-6 p-0 box-border flex items-center justify-center"
                          onClick={() => navigate("/ecosystem")}
                          aria-label="Open ZYRAXON Ecosystem"
                        >
