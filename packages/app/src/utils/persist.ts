...
const GLOBAL_STORAGE = "zyraxon.global.dat"
const WINDOW_STORAGE = "zyraxon.window"
const LOCAL_PREFIX = "zyraxon."
...
function workspaceStorage(dir: string) {
  ...
  return `zyraxon.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `zyraxon.draft.${head}.${sum}.dat`
}
