...
export class Service extends Context.Service<Service, Interface>()("@zyraxon/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ZYRAXON_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
