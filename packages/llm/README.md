...
Schema-first LLM core for ZYRAXON. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@ZYRAXON-ai/llm"
import { OpenAI } from "@ZYRAXON-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@ZYRAXON-ai/llm/providers"
