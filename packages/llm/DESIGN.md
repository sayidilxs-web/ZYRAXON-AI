...
> current private `@ZYRAXON-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@ZYRAXON-ai/ai`
...
- Secondary audience: ZYRAXON and other durable agent runtimes
...
import { LLM } from "@ZYRAXON-ai/ai"
import { OpenAI } from "@ZYRAXON-ai/ai/providers/openai"
...
```ts
import { Message } from "@ZYRAXON-ai/ai"
...
import { LLM, Tool } from "@ZYRAXON-ai/ai"
...
ZYRAXON and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@ZYRAXON-ai/ai/promise"
import { OpenAI } from "@ZYRAXON-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@ZYRAXON-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@ZYRAXON-ai/ai/provider"
...
@ZYRAXON-ai/ai/promise
  Promise/AsyncIterable LLM facade

@ZYRAXON-ai/ai/schema
  serializable domain schemas

@ZYRAXON-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@ZYRAXON-ai/ai/providers/openai
@ZYRAXON-ai/ai/providers/anthropic
@ZYRAXON-ai/ai/providers/google
...
```
...
ZYRAXON should migrate to `generateTurn` / `streamTurn`, preserving its durable
