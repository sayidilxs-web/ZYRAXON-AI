...
opencode'u ACP aracılığıyla kullanmak için düzenleyicinizi `zyraxon acp` komutunu çalıştıracak şekilde yapılandırın.
...
Açmak için AI Chat agent seçicisindeki yeni 'ZYRAXON' ajanını kullanın.
