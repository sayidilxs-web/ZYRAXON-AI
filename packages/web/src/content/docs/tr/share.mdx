...
3. Konusmayi paylasim baglantisiyla erisilebilir hale getirir - `zyraxonai.lovable.app/share/<share-id>`
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `zyraxon.json` dosyasina ekleyip Git'e commit edin.
