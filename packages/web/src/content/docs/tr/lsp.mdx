...
description: ZYRAXON, LSP sunucularınızla bütünleşir.
---

ZYRAXON, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

ZYRAXON, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
