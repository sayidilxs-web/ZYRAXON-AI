...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | ZYRAXON oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile ZYRAXON kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | ZYRAXON oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | ZYRAXON bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | ZYRAXON aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | ZYRAXON için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | ZYRAXON için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, ZYRAXON oturumlarını kontrol eden Discord botu       |
...
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden ZYRAXON için mobil öncelikli web arayüzü               |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | ZYRAXON eklentileri oluşturmak için şablon                                     |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @zyraxon-ai/sdk aracılığıyla ZYRAXON kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | ZYRAXON için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [ZYRAXON-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | ZYRAXON'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
...
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip ZYRAXON eklenti yöneticisi                 |
