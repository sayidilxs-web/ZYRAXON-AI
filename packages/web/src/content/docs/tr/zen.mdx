...
ZYRAXON Zen, ZYRAXON ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, ZYRAXON'daki diğer sağlayıcılar gibi çalışır. ZYRAXON Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve ZYRAXON kullanmak için buna ihtiyacınız yoktur.
...
:::tip
ZYRAXON ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
ZYRAXON Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

ZYRAXON Zen, ZYRAXON'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>ZYRAXON Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, ZYRAXON Zen'i seçin ve API anahtarınızı yapıştırın.
...
ZYRAXON yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için ZYRAXON'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için ZYRAXON'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için ZYRAXON'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için ZYRAXON'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için ZYRAXON'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
ZYRAXON Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca ZYRAXON ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
