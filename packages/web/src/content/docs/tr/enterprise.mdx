...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını zyraxon.ai'de barındırmak için kullandığımız hizmete gönderilir.
