...
En iyi deneyim için PowerShell yerine `zyraxon web`'yi [WSL](/docs/windows-wsl)'den çalıştırın. Bu, uygun dosya sistemi erişimini ve terminal entegrasyonunu sağlar.
:::
...
Sunucu ayarlarını `zyraxon.json` yapılandırma dosyanızda da yapılandırabilirsiniz:
