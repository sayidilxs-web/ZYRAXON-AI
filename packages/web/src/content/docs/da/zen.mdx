---
title: Zen
description: Udvalgt liste over modeller leveret af ZYRAXON.
---
...
ZYRAXON Zen er en liste over testede og verificerede modeller leveret af ZYRAXON-teamet.

Zen fungerer som enhver anden udbyder i ZYRAXON. Du logger ind på ZYRAXON Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med ZYRAXON.
:::
...
ZYRAXON Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

ZYRAXON Zen fungerer som enhver anden udbyder i ZYRAXON.

1. Du logger ind på **<a href={console}>ZYRAXON Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger ZYRAXON Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din ZYRAXON-konfiguration
...
- DeepSeek V4 Flash Free er tilgængelig på ZYRAXON i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på ZYRAXON i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på ZYRAXON i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på ZYRAXON i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på ZYRAXON i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med ZYRAXON også.
