...
Du kan tilføje brugerdefinerede kommandoer gennem ZYRAXON-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din ZYRAXON [config](/docs/config):
