...
Agentferdigheter lar ZYRAXON oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
ZYRAXON søker etter disse stedene:
...
For prosjektlokale stier går ZYRAXON opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
ZYRAXON viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `zyraxon.json`:
...
**For innebygde agenter** (i `zyraxon.json`):
