...
ZYRAXONs delingsfunksjon lar deg lage offentlige lenker til dine ZYRAXON-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
3. Gør samtalen tilgængelig via den delbare lenken — `zyraxonai.lovable.app/share/<share-id>`
...
Som standard bruger ZYRAXON manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `zyraxon.json` i prosjektet ditt og tjek inn i Git.
