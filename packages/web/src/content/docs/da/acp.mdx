...
description: Brug ZYRAXON i enhver ACP-kompatibel editor.
---

ZYRAXON understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge ZYRAXON via ACP, konfigurer din editor til at køre kommandoen `zyraxon acp`.

Kommandoen starter ZYRAXON som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'ZYRAXON'-agent i AI Chat-agentvælgeren.
...
For at bruge ZYRAXON som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge ZYRAXON som ACP-agent til chat.
...
ZYRAXON fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din ZYRAXON-konfiguration
