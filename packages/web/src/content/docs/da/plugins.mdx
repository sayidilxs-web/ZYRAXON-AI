---
title: Plugins
description: Skriv dine egne plugins for at udvide ZYRAXON.
---

Plugins giver dig mulighed for at udvide ZYRAXON ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre ZYRAXONs standardadfærd.
...
1. Global konfiguration (`~/.config/opencode/zyraxon.json`)
...
ZYRAXON kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger ZYRAXON desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
...
Niveauer: `debug`, `info`, `warn`, `error`. Se [SDK documentation](https://zyraxon.ai/docs/sdk) for detaljer.
