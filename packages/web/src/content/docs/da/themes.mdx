...
Med ZYRAXON kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger ZYRAXON vårt eget `opencode`-tema.
...
ZYRAXON kommer med flere innebygde temaer.
...
- Vil at ZYRAXON skal matche terminalens utseende
...
ZYRAXON støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
