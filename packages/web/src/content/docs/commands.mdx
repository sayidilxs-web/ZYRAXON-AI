...
You can add custom commands through the ZYRAXON config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your ZYRAXON [config](/docs/config):
