...
代理技能讓 ZYRAXON 能夠從你的儲存庫或主目錄中發現可重複使用的指令。
...
對於專案本地路徑，ZYRAXON 會從當前工作目錄向上遍歷，直到到達 git 工作樹根目錄。
...
在 `zyraxon.json` 中使用基於模式的權限來控制代理可以存取哪些技能：
