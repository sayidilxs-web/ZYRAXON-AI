---
title: Condivisione
description: Condividi le tue conversazioni ZYRAXON.
---

La funzione di condivisione di ZYRAXON ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, ZYRAXON:

1. Crea un URL pubblico univoco per la sessione
2. Sincronizza la cronologia della conversazione sui nostri server
3. Rende la conversazione accessibile tramite il link condivisibile: `zyraxonai.lovable.app/share/<share-id>`

---

## Condivisione

ZYRAXON supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, ZYRAXON usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `zyraxon.json` nel progetto e versionalo su Git.
