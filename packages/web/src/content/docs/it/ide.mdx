---
title: IDE
description: L'estensione ZYRAXON per VS Code, Cursor e altri IDE
---

ZYRAXON si integra con VS Code, Cursor o qualunque IDE che supporti un terminale. Basta eseguire `opencode` nel terminale per iniziare.

---

## Utilizzo

- **Avvio rapido**: usa `Cmd+Esc` (Mac) o `Ctrl+Esc` (Windows/Linux) per aprire ZYRAXON in una vista terminale divisa, oppure per mettere a fuoco una sessione esistente se e gia in esecuzione.
- **Nuova sessione**: usa `Cmd+Shift+Esc` (Mac) o `Ctrl+Shift+Esc` (Windows/Linux) per avviare una nuova sessione di ZYRAXON, anche se ne esiste gia una aperta. Puoi anche cliccare il pulsante ZYRAXON nell'interfaccia.
- **Consapevolezza del contesto**: condividi automaticamente con ZYRAXON la selezione corrente o la scheda attiva.
...
Per installare ZYRAXON su VS Code e fork popolari come Cursor, Windsurf, VSCodium:
...
Cerca **ZYRAXON** nel Marketplace delle estensioni e clicca **Install**.
