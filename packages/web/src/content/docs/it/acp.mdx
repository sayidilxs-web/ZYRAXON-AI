---
title: Supporto ACP
description: Usa ZYRAXON in qualunque editor compatibile con ACP.
---

ZYRAXON supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare ZYRAXON via ACP, configura l'editor in modo che esegua il comando `zyraxon acp`.

Il comando avvia ZYRAXON come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'ZYRAXON' nel selettore agenti di AI Chat.
...
Per usare ZYRAXON come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare ZYRAXON come agente ACP per la chat.
...
ZYRAXON funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione ZYRAXON
