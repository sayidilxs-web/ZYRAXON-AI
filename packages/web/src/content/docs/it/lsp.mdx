---
title: Server LSP
description: ZYRAXON si integra con i tuoi server LSP.
---

ZYRAXON può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

ZYRAXON include diversi server LSP integrati per linguaggi popolari:
