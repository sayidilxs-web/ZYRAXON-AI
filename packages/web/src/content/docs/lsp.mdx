---
title: LSP Servers
description: ZYRAXON integrates with your LSP servers.
---

ZYRAXON can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

ZYRAXON comes with several built-in LSP servers for popular languages:
