...
Du kan legge til egendefinerte kommandoer gjennom ZYRAXON-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i ZYRAXON [config](/docs/config):
...
ZYRAXON inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
