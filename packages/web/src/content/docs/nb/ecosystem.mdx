...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør ZYRAXON-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor ZYRAXON-bruk med Wakatime                                                                               |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for ZYRAXON-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på ZYRAXON-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat ZYRAXON-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid ZYRAXON /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for ZYRAXON – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for ZYRAXON                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere ZYRAXON-økter, bygget på SDK         |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge ZYRAXON-plugins                                    |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-grensesnitt for ZYRAXON - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av ZYRAXON via @zyraxon-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for ZYRAXON               |
| [ZYRAXON-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn ZYRAXON i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av ZYRAXON  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | ZYRAXON utvidelsesbehandler med bærbare, isolerte profiler.        |
