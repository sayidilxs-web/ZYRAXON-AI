---
title: SDK
description: Typesikker JS-klient for ZYRAXON-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ZYRAXON JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere ZYRAXON programmatisk.
...
Opprett en forekomst av ZYRAXON:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `zyraxon.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av ZYRAXON, kan du opprette en klientforekomst for å koble til den:
