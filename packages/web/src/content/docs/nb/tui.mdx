...
ZYRAXON gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre ZYRAXON starter TUI for gjeldende katalog.
...
Når du bruker ZYRAXON TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til ZYRAXON. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt ZYRAXON. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `zyraxon.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge ZYRAXON venter etter leader key. Standard er `2000`.
