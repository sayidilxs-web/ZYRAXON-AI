---
title: Deling
description: Del dine ZYRAXON-samtaler.
---

Delingsfunksjonen i ZYRAXON lar deg lage offentlige lenker til dine ZYRAXON-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, ZYRAXON:

1. Oppretter en unik offentlig URL for økten din
2. Synkroniserer samtaleloggen din til serverne våre
3. Gjør samtalen tilgjengelig via den delbare lenken — `zyraxonai.lovable.app/share/<share-id>`

---

## Deling

ZYRAXON støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker ZYRAXON manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `zyraxon.json` i prosjektet ditt og sjekk det inn i Git.
