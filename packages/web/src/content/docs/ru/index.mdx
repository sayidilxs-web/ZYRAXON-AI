...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [zyraxon.ai/auth](https://zyraxon.ai/auth).
...
Вот [пример диалога](https://zyraxon.ai/s/4XP1fce5) с opencode.
