...
Контролируйте, к каким навыкам агенты могут получить доступ, используя разрешения на основе шаблонов в `zyraxon.json`:
...
**Для встроенных агентов** (в формате `zyraxon.json`):
