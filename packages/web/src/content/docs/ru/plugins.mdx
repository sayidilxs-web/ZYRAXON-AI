...
1. Глобальная конфигурация (`~/.config/opencode/zyraxon.json`)
2. Конфигурация проекта (`zyraxon.json`)
...
Уровни: `debug`, `info`, `warn`, `error`. Подробности см. в документации SDK](https://zyraxon.ai/docs/sdk).
