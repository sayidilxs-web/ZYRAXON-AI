...
Você também pode baixar o binário na seção [Releases](https://github.com/onelpawarai/ZYRAXON-AI/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [ZYRAXON Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [zyraxon.ai/auth](https://zyraxon.ai/auth).
...
Aqui está uma [conversa de exemplo](https://zyraxon.ai/s/4XP1fce5) com o opencode.
