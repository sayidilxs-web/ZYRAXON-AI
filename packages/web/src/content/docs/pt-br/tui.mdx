...
Isso é separado do `zyraxon.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o ZYRAXON espera depois da leader key. O padrão é `2000`.
