...
3. Torna a conversa acessível através do link compartilhável — `zyraxonai.lovable.app/share/<share-id>`
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `zyraxon.json` em seu projeto e faça o check-in no Git.
