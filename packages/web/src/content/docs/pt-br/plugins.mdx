...
1. Configuração global (`~/.config/opencode/zyraxon.json`)
2. Configuração do projeto (`zyraxon.json`)
...
Níveis: `debug`, `info`, `warn`, `error`. Veja a [documentação do SDK](https://zyraxon.ai/docs/sdk) para detalhes.
