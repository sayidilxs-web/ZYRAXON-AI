...
Puede agregar comandos personalizados a través de la configuración ZYRAXON o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su ZYRAXON [config](/docs/config):
