...
description: ZYRAXON se integra con sus servidores LSP.
---

ZYRAXON puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

ZYRAXON viene con varios servidores LSP integrados para idiomas populares:
