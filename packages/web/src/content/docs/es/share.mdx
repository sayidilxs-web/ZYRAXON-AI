---
title: Compartir
description: Comparte tus conversaciones ZYRAXON.
---

La función para compartir de ZYRAXON te permite crear enlaces públicos a tus conversaciones de ZYRAXON, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, ZYRAXON:

1. Crea una URL pública única para su sesión.
2. Sincroniza tu historial de conversaciones con nuestros servidores
3. Hace que la conversación sea accesible a través del enlace para compartir: `zyraxonai.lovable.app/share/<share-id>`

---

## Uso compartido

ZYRAXON admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, ZYRAXON usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `zyraxon.json` en su proyecto y regístrelo en Git.
