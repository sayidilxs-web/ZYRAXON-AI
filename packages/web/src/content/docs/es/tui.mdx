---
title: TUI
description: Usando la interfaz de usuario del terminal ZYRAXON.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ZYRAXON proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar ZYRAXON se inicia TUI para el directorio actual.
...
Cuando utilice ZYRAXON TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a ZYRAXON. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de ZYRAXON. _Alias_: `/quit`, `/q`
...
Esto es independiente de `zyraxon.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera ZYRAXON después de la leader key. El valor predeterminado es `2000`.
