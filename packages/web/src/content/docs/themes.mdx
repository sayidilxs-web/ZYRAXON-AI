...
With ZYRAXON you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, ZYRAXON uses our own `opencode` theme.
...
ZYRAXON comes with several built-in themes.
...
- Want ZYRAXON to match their terminal's appearance
...
ZYRAXON supports a flexible JSON-based theme system that allows users to create and customize themes easily.
