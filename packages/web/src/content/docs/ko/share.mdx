...
2. 우리의 서버에 대화 기록 동기화
3. 공유 가능한 링크를 통해 접근 할 수있는 대화 만들기 — `zyraxonai.lovable.app/share/<share-id>`
...
주어진 프로젝트를 위해 팀 전반에 걸쳐 이것을 시행하려면 프로젝트에 `zyraxon.json`에 추가하고 Git로 확인하십시오.
