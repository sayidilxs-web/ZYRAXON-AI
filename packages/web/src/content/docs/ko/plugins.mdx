---
title: 플러그인
description: ZYRAXON를 확장하기 위해 자신만의 플러그인을 작성하세요.
---
...
1. 글로벌 구성 (`~/.config/opencode/zyraxon.json`)
2. 프로젝트 구성 (`zyraxon.json`)
...
레벨: `debug`, `info`, `warn`, `error`. [SDK 문서](https://zyraxon.ai/docs/sdk)를 참고하세요.
