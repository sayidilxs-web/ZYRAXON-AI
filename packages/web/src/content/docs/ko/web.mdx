---
title: Web
description: 브라우저에서 ZYRAXON 사용하기.
---
...
:::tip[Windows 사용자]
최고의 경험을 위해서는 PowerShell보다 `zyraxon web`를 실행하십시오. 적절한 파일 시스템 액세스 및 terminal 통합을 보장합니다.
:::
...
`zyraxon.json` config 파일에서 서버 설정을 구성할 수 있습니다:
