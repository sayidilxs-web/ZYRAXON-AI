...
代理技能让 ZYRAXON 能够从你的仓库或主目录中发现可复用的指令。
...
对于项目本地路径，ZYRAXON 会从当前工作目录向上遍历，直到到达 git 工作树根目录。
...
在 `zyraxon.json` 中使用基于模式的权限来控制代理可以访问哪些技能：
