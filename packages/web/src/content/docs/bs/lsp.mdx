---
title: LSP serveri
description: ZYRAXON se integriše sa vašim LSP serverima.
---

ZYRAXON se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

ZYRAXON dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
