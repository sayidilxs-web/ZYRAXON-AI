---
title: TUI
description: Korištenje korisničkog interfejsa ZYRAXON terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ZYRAXON pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje ZYRAXON pokreće TUI za trenutni direktorij.
...
Kada koristite ZYRAXON TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u ZYRAXON. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz ZYRAXON. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `zyraxon.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo ZYRAXON čeka nakon leader key. Podrazumijevano je `2000`.
