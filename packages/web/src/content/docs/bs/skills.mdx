...
Agent skills omogucavaju ZYRAXON da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
ZYRAXON pretrazuje ove lokacije:
...
Za projektne lokalne putanje, ZYRAXON ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
ZYRAXON navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `zyraxon.json`:
...
**Za ugradene agente** (u `zyraxon.json`):
