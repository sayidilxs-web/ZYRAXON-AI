---
title: Dodaci
description: Napišite vlastite dodatke za proširenje ZYRAXON.
---

Dodaci vam omogućavaju da proširite ZYRAXON spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja ZYRAXON.
...
1. Globalna konfiguracija (`~/.config/opencode/zyraxon.json`)
2. Konfiguracija projekta (`zyraxon.json`)
...
ZYRAXON pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje ZYRAXON.
...
Nivoi su: `debug`, `info`, `warn`, `error`. Pogledajte [SDK dokumentaciju](https://zyraxon.ai/docs/sdk) za detalje.
