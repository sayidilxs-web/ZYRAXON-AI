---
title: Web
description: Korišćenje ZYRAXON u vašem pretraživaču.
---

ZYRAXON može raditi kao web aplikacija u vašem pretraživaču, pružajući isto moćno iskustvo AI kodiranja bez potrebe za terminalom.

![ZYRAXON Web - Nova sesija](../../../assets/web/web-homepage-new-session.png)
...
Ovo pokreće lokalni server na `127.0.0.1` sa nasumičnim dostupnim portom i automatski otvara ZYRAXON u vašem podrazumevanom pretraživaču.
...
Za najbolje iskustvo, pokrenite `zyraxon web` iz [WSL](/docs/windows-wsl) umjesto PowerShell-a. Ovo osigurava pravilan pristup sistemu datoteka i integraciju terminala.
:::
...
ZYRAXON podrazumevano bira dostupni port. Možete odrediti port:
...
Podrazumevano, server se vezuje za `127.0.0.1` (samo lokalni host). Da biste ZYRAXON učinili dostupnim na vašoj mreži:

```bash
opencode web --hostname 0.0.0.0
```

Kada koristite `0.0.0.0`, ZYRAXON će prikazati i lokalne i mrežne adrese:
...
Jednom pokrenut, web sučelje pruža pristup vašim ZYRAXON sesijama.

### Sesije

Pregledajte i upravljajte svojim sesijama sa početne stranice. Možete vidjeti aktivne sesije i započeti nove.

![ZYRAXON Web - aktivna sesija](../../../assets/web/web-homepage-active-session.png)

### Status servera

Kliknite "Pogledajte servere" da vidite povezane servere i njihov status.

![ZYRAXON Web - Vidi servere](../../../assets/web/web-homepage-see-servers.png)
...
Također možete konfigurirati postavke servera u svom `zyraxon.json` konfiguracijskom fajlu:
