...
U ZYRAXON mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, ZYRAXON koristi nasu `opencode` temu.
...
ZYRAXON dolazi sa vise ugradenih tema.
...
- Zele da ZYRAXON odgovara izgledu njihovog terminala
...
ZYRAXON podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
