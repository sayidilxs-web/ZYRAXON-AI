---
title: ACP podrška
description: Koristite ZYRAXON u bilo kojem uređivaču kompatibilnom sa ACP.
---

ZYRAXON podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili ZYRAXON putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `zyraxon acp`.

Naredba pokreće ZYRAXON kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "ZYRAXON" agenta u AI Chat agent selektoru.
...
Da koristite ZYRAXON kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi ZYRAXON kao ACP chat agenta.
...
ZYRAXON radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj ZYRAXON konfiguraciji
