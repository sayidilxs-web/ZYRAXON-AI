...
مع ZYRAXON يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم ZYRAXON سمتنا `opencode`.
...
يأتي ZYRAXON مع عدة سمات مدمجة.
...
- يريدون أن يطابق ZYRAXON مظهر terminal لديهم
...
يدعم ZYRAXON نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
