---
title: دعم ACP
description: استخدم ZYRAXON في أي محرر متوافق مع ACP.
---

يدعم ZYRAXON بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام ZYRAXON عبر ACP، اضبط محررك ليشغّل الأمر `zyraxon acp`.

يشغّل هذا الأمر ZYRAXON كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'ZYRAXON' من محدد الوكلاء في AI Chat.
...
لاستخدام ZYRAXON كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام ZYRAXON كوكيل ACP للدردشة.
...
يعمل ZYRAXON عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات ZYRAXON
