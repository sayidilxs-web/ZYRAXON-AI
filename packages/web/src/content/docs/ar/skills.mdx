...
تتيح مهارات الوكيل لـ ZYRAXON اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج ZYRAXON صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض ZYRAXON المهارات المتاحة في وصف أداة `skill`.
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `zyraxon.json`:
...
**للوكلاء المدمجين** (في `zyraxon.json`):
