---
title: IDE
description: امتداد ZYRAXON لـ VS Code و Cursor وغيرها من بيئات التطوير
---

يتكامل ZYRAXON مع VS Code و Cursor أو أي IDE يدعم terminal. ما عليك سوى تشغيل `opencode` في terminal للبدء.

---

## الاستخدام

- **تشغيل سريع**: استخدم `Cmd+Esc` (Mac) أو `Ctrl+Esc` (Windows/Linux) لفتح ZYRAXON في عرض terminal مقسّم، أو للتركيز على جلسة terminal موجودة إذا كانت قيد التشغيل بالفعل.
- **جلسة جديدة**: استخدم `Cmd+Shift+Esc` (Mac) أو `Ctrl+Shift+Esc` (Windows/Linux) لبدء جلسة terminal جديدة لـ ZYRAXON حتى لو كانت هناك جلسة مفتوحة. يمكنك أيضا النقر على زر ZYRAXON في واجهة المستخدم.
- **وعي بالسياق**: شارك تلقائيا تحديدك الحالي أو تبويبك مع ZYRAXON.
...
لتثبيت ZYRAXON على VS Code والتفرعات الشائعة مثل Cursor و Windsurf و VSCodium:
...
ابحث عن **ZYRAXON** في Extension Marketplace وانقر **Install**.
