---
title: TUI
description: استخدام واجهة المستخدم TUI في ZYRAXON.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر ZYRAXON واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل ZYRAXON إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة ZYRAXON في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى ZYRAXON. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من ZYRAXON. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `zyraxon.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار ZYRAXON بعد الضغط على leader key. القيمة الافتراضية `2000`.
