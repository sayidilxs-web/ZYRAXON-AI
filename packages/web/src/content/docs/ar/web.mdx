---
title: الويب
description: استخدام ZYRAXON في متصفحك.
---

يمكن تشغيل ZYRAXON كتطبيق ويب داخل متصفحك، ليمنحك تجربة البرمجة القوية بالذكاء الاصطناعي نفسها دون الحاجة إلى terminal.

![ZYRAXON Web - جلسة جديدة](../../../assets/web/web-homepage-new-session.png)
...
يؤدي ذلك إلى تشغيل خادم محلي على `127.0.0.1` بمنفذ عشوائي متاح، ويفتح ZYRAXON تلقائيا في المتصفح الافتراضي لديك.
...
:::tip[مستخدمو Windows]
لأفضل تجربة، شغّل `zyraxon web` من [WSL](/docs/windows-wsl) بدلا من PowerShell. يضمن ذلك وصولا صحيحا إلى نظام الملفات وتكاملا أفضل مع terminal.
:::
...
افتراضيا، يختار ZYRAXON منفذا متاحا. يمكنك تحديد منفذ:
...
افتراضيا، يرتبط الخادم بـ `127.0.0.1` (للاستخدام المحلي فقط). لجعل ZYRAXON متاحا على شبكتك:

```bash
opencode web --hostname 0.0.0.0
```

عند استخدام `0.0.0.0` سيعرض ZYRAXON كلا من عناوين الوصول المحلي وعناوين الشبكة:
...
بعد التشغيل، تتيح لك واجهة الويب الوصول إلى جلسات ZYRAXON الخاصة بك.

### الجلسات

اعرض جلساتك وأدرها من الصفحة الرئيسية. يمكنك رؤية الجلسات النشطة وبدء جلسات جديدة.

![ZYRAXON Web - جلسة نشطة](../../../assets/web/web-homepage-active-session.png)

### حالة الخادم

انقر على "See Servers" لعرض الخوادم المتصلة وحالتها.

![ZYRAXON Web - See Servers (عرض الخوادم)](../../../assets/web/web-homepage-see-servers.png)
...
يمكنك أيضا ضبط إعدادات الخادم داخل ملف الإعدادات `zyraxon.json`:
