---
title: الإضافات
description: اكتب إضافاتك الخاصة لتوسيع ZYRAXON.
---

تتيح لك الإضافات توسيع ZYRAXON عبر ربطها بأحداث مختلفة وتخصيص السلوك. يمكنك إنشاء إضافات لإضافة ميزات جديدة، أو التكامل مع خدمات خارجية، أو تعديل السلوك الافتراضي لـ ZYRAXON.
...
1. إعدادات عامة (`~/.config/opencode/zyraxon.json`)
2. إعدادات المشروع (`zyraxon.json`)
...
يشغّل ZYRAXON الأمر `bun install` عند بدء التشغيل لتثبيتها. بعد ذلك يمكن لإضافاتك وأدواتك استيرادها.
...
:::note
إذا كنت تستخدم تطبيق ZYRAXON لسطح المكتب، فيمكنه إرسال إشعارات النظام تلقائيا عند جاهزية الرد أو عند حدوث خطأ في جلسة.
:::
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://zyraxon.ai/docs/sdk) للتفاصيل.
