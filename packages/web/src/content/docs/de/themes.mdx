...
Mit ZYRAXON kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet ZYRAXON das `opencode`-Theme.
...
ZYRAXON liefert mehrere eingebaute Themes mit.
...
- ZYRAXON optisch ans Terminal anpassen wollen
...
ZYRAXON unterstuetzt ein flexibles JSON-basiertes Theme-System.
