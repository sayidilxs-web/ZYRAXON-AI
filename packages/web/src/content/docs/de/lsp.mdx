---
title: LSP Server
description: ZYRAXON lässt sich in Ihren LSP-Server integrieren.
---

ZYRAXON kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

ZYRAXON verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und ZYRAXON eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer ZYRAXON-Konfiguration aktivieren und anpassen.
