...
description: Erstellen Sie Tools, die der LLM in ZYRAXON aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von ZYRAXON wie `read`, `write` und `bash`.
...
import { tool } from "@zyraxon-ai/plugin"
