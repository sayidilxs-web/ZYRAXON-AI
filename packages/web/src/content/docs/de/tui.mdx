---
title: TUI
description: Arbeite mit ZYRAXON in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ZYRAXON bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet ZYRAXON die TUI im aktuellen Verzeichnis.
...
In der ZYRAXON-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu ZYRAXON hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet ZYRAXON. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `zyraxon.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
- `leader_timeout` - Steuert, wie lange ZYRAXON nach der leader key wartet. Standard ist `2000`.
