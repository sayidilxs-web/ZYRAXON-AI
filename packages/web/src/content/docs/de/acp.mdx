...
description: Verwenden Sie ZYRAXON in jedem ACP-kompatiblen Editor.
---

ZYRAXON unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um ZYRAXON über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `zyraxon acp`.

Der Befehl startet ZYRAXON als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „ZYRAXON“ in der AI Chat Agent Selector.
...
Um ZYRAXON als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass ZYRAXON als ACP-Agent für den Chat verwendet wird.
...
ZYRAXON funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer ZYRAXON-Konfiguration konfiguriert sind
