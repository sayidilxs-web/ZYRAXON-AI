...
Les compétences d'agent permettent à ZYRAXON de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
ZYRAXON recherche ces emplacements :
...
Pour les chemins locaux du projet, ZYRAXON remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
ZYRAXON répertorie les compétences disponibles dans la description de l'outil `skill`.
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `zyraxon.json` :
...
**Pour les agents intégrés** (dans `zyraxon.json`) :
