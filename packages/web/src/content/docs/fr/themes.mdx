...
Avec ZYRAXON, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, ZYRAXON utilise notre propre thème `opencode`.
...
ZYRAXON est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que ZYRAXON corresponde à l'apparence de leur terminal
...
ZYRAXON prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
{
  "$schema": "https://zyraxon.ai/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
