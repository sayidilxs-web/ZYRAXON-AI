...
Vous pouvez ajouter des commandes personnalisées via la configuration ZYRAXON ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre ZYRAXON [config](/docs/config) :
