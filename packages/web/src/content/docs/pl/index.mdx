...
Możesz także pobrać plik binarny z [Releases](https://github.com/onelpawarai/ZYRAXON-AI/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [ZYRAXON Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [zyraxon.ai/auth](https://zyraxon.ai/auth).
...
Oto [przykładowa rozmowa](https://zyraxon.ai/s/4XP1fce5) z opencode.
