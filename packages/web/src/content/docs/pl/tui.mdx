...
Jest to oddzielny plik od `zyraxon.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo ZYRAXON czeka po naciśnięciu leader key. Domyślnie `2000`.
