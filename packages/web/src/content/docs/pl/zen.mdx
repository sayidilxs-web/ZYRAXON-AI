---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez ZYRAXON.
---
...
ZYRAXON Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół ZYRAXON.

Zen działa jak każdy inny dostawca w ZYRAXON. Logujesz się do ZYRAXON Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z ZYRAXON.
:::
...
ZYRAXON Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

ZYRAXON Zen działa jak każdy inny dostawca w ZYRAXON.

1. Logujesz się do **<a href={console}>ZYRAXON Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz ZYRAXON Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji ZYRAXON używa formatu
...
- DeepSeek V4 Flash Free jest dostępny w ZYRAXON przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w ZYRAXON przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w ZYRAXON przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w ZYRAXON przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w ZYRAXON przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w ZYRAXON także dowolnego innego dostawcy.
