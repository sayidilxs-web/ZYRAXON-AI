...
Kontroluj, do których umiejętności agenci mogą uzyskać dostęp, używając uprawnień opartych na wzorcach w `zyraxon.json`:
...
**Dla agentów wbudowanych** (w `zyraxon.json`):
