...
1. Konfiguracja globalna (`~/.config/opencode/zyraxon.json`)
2. Konfiguracja projektu (`zyraxon.json`)
...
Poziomy: `debug`, `info`, `warn`, `error`. Aby uzyskać szczegółowe informacje, zobacz [dokumentację pakietu SDK](https://zyraxon.ai/docs/sdk).
