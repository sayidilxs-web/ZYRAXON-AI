...
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `zyraxonai.lovable.app/share/<share-id>`
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `zyraxon.json` w swoim projekcie i sprawdź w Git.
