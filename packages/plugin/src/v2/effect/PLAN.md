...
- Effect plugins import `@ZYRAXON-ai/plugin/v2/effect`, not `@ZYRAXON-ai/core`.
- Public domain values use generated `@ZYRAXON-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@ZYRAXON-ai/plugin/v2/effect`.
