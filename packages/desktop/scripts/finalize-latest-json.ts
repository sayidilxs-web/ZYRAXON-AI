...
const releaseId = process.env.ZYRAXON_RELEASE
if (!releaseId) throw new Error("ZYRAXON_RELEASE is required")

const version = process.env.ZYRAXON_VERSION
if (!version) throw new Error("ZYRAXON_VERSION is required")
