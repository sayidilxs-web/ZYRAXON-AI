export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von ZYRAXON",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von ZYRAXON wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
