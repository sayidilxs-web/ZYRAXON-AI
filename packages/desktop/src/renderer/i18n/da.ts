export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af ZYRAXON",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af ZYRAXON er blevet downloadet. Vil du installere den og genstarte?",
