export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de ZYRAXON",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de ZYRAXON. ¿Quieres instalarla y reiniciar?",
