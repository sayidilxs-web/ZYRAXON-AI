export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju ZYRAXON-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} ZYRAXON-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
