export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av ZYRAXON",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av ZYRAXON er lastet ned. Vil du installere den og starte på nytt?",
