export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'ZYRAXON",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'ZYRAXON a été téléchargée. Voulez-vous l'installer et redémarrer ?",
