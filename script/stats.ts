...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/onelpawarai/ZYRAXON-AI/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for onelpawarai/ZYRAXON-AI...\n")
